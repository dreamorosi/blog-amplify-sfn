...
export class cdkStack extends cdk.Stack {
  constructor(
    ...
    const dependencies: AmplifyDependentResourcesAttributes =
      AmplifyHelpers.addResourceDependency(
        ...
        [
          {
            category: "api",
            resourceName: "blogamplifysfn", // <- name of your API resource
          },
        ]
      );
    ...
    const apiId = cdk.Fn.ref(
      dependencies.api.blogamplifysfn.GraphQLAPIIdOutput // <- Adjust with name of your API resource
    );
    ...
    */
    customer_support_topic.addSubscription(
      new subs.EmailSubscription("xipefo5655@harcity.com") // <- replace with your email
    );
